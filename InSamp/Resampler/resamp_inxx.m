...
processor       = 'ISCE';                                                   % Can be 'ISCE', 'ROIPAC', or 'GMT'. GMT inputs should be converted to .xyz files prior to running using grd2xyz
...
zone            = '33T';                                                    % UTM zone; zone = 0 forces data loading to check zone
